...
export function TermsPage({ onBack }: TermsPageProps) {
  return (
    <PageLayout title="Termos de Uso" onBack={onBack}>
      ...
      <h2 className="text-xl font-semibold text-[#2D3436] mt-8 mb-2">Publicidade</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold text-[#2D3436] mt-8 mb-2">Alterações nos termos</h2>
      <p>

...
export function PrivacyPage({ onBack }: PrivacyPageProps) {
  return (
    <PageLayout title="Política de Privacidade" onBack={onBack}>
      ...
      <h2 className="text-xl font-semibold text-[#2D3436] mt-8 mb-2">
      ...
      <h2 className="text-xl font-semibold text-[#2D3436] mt-8 mb-2">Cookies e publicidade</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold text-[#2D3436] mt-8 mb-2">Seus direitos (LGPD)</h2>
      <p>
